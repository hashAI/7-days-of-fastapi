# I've joined the #7DaysOfFastapi Challenge
...
0.  Check out [the Official Site](http://7DaysOfFastapi.com/) for the #7DaysOfFastapi movement. Connect with others on the platform of your choice from this list: www.7DaysOfFastapi.com/connect
    Also, [here](https://www.7DaysOfFastapi.com/slack) is a invite link to the 7DaysOfFastapi Slack channel
1.  Read [Join the #7DaysOfFastapi](https://medium.freecodecamp.com/join-the-7DaysOfFastapi-556ddb4579e4)
2.  Fork this repo and commit to the [Log](log.md) or to the Alternative, rapid [R1 Log](r1-log.md) (R1 stands for Round 1) daily. [Example](https://github.com/Kallaway/7-days-kallaway-log).
3.  **Code minimum an hour every day for the next 7 days.**
4.  **Encourage at least two other people in the challenge on Twitter every day! Pay it forward!**
5.  Change the date in [Rules](rules.md) to the day you've started the challenge.
6.  Delete the examples in the log, or comment them out, and start filling it with your own content.
7.  **Tweet your progress every day using the #7DaysOfFastapi hashtag.**
8.  Follow [Alex, creator of #7DaysOfFastapi](https://twitter.com/ka11away) & [7DaysOfFastapi](https://twitter.com/_7DaysOfFastapi) Twitter Bot that retweets the tweets that contain the #7DaysOfFastapi hashtag. It's a great way to keep yourself motivated and to participate in the community. Thanks [@amanhimself](https://twitter.com/amanhimself) for creating it!
...
Check out [the #7DaysOfX Challenges Project](http://7daysofx.com/). Changing your habits you are changing your life. Remember that the best time to start is always NOW.

I recommend that you commit to no more than 2-3 challenges at a time, ideally 2. If you are doing the #7DaysOfFastapi which involves a lot of mental activity, try the [#7DaysOfHealth](http://7daysofx.com/where-x-is/health/), or [#7DaysOfFitness](http://7daysofx.com/challenges/) challenges. There is so much more on the site, check all of them out and choose the ones you want to acquire! Languages, writing, meditation, journaling, cooking, and more!

## Note

- If you have any questions or ideas about 7DaysOfFastapi (or other ideas), feel free to reach out to me on Twitter: [@ka11away](https://twitter.com/ka11away)
