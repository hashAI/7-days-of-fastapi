# I've joined the #7DaysOfCode Challenge
...
0.  Check out [the Official Site](http://7daysofcode.com/) for the #7DaysOfCode movement. Connect with others on the platform of your choice from this list: www.7DaysOfCode.com/connect
    Also, [here](https://www.7daysofcode.com/slack) is a invite link to the 7DaysOfCode Slack channel
1.  Read [Join the #7DaysOfCode](https://medium.freecodecamp.com/join-the-7daysofcode-556ddb4579e4)
...
7.  **Tweet your progress every day using the #7DaysOfCode hashtag.**
8.  Follow [Alex, creator of #7DaysOfCode](https://twitter.com/ka11away) & [7DaysOfCode](https://twitter.com/_7DaysOfCode) Twitter Bot that retweets the tweets that contain the #7DaysOfCode hashtag. It's a great way to keep yourself motivated and to participate in the community. Thanks [@amanhimself](https://twitter.com/amanhimself) for creating it!
...
I recommend that you commit to no more than 2-3 challenges at a time, ideally 2. If you are doing the #7DaysOfCode which involves a lot of mental activity, try the [#7DaysOfHealth](http://7daysofx.com/where-x-is/health/), or [#7DaysOfFitness](http://7daysofx.com/challenges/) challenges. There is so much more on the site, check all of them out and choose the ones you want to acquire! Languages, writing, meditation, journaling, cooking, and more!

## Note

- If you have any questions or ideas about 7DaysOfCode (or other ideas), feel free to reach out to me on Twitter: [@ka11away](https://twitter.com/ka11away)
